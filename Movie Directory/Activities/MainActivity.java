...
import app.directoy.movie.moviedirectory.Data.MovieRecyclerViewAdapter;
...
import app.directoy.movie.moviedirectory.Util.Prefs;
...
public class MainActivity extends AppCompatActivity {
    ...
    public List<Movie> getMovies(String searchTerm) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Constants.URL_LEFT + searchTerm + Constants.URL_RIGHT, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                try {
                    ...
                    /**
                     * Very Important!! Otherwise, we won't seeanything being displayed.
                     */
                    movieRecyclerViewAdapter.notifyDataSetChanged();
